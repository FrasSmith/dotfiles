...
static const char col_cyan[]        = "#336699"; /* was #6CF982  */
...
const char *spcmd1[] = {"kitty", "--class", "spterm1", "--title", "Music", "-o", "initial_window_width=100c", "-o", "initial_window_height=30c", "-e", "mocp", NULL };
...
/* tagging */
static const char *tags[] = { "HOME", "WEB", "CHAT", "MEDIA", "DEV", "MISC" };
