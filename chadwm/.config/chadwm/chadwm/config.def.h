...
static const char *fonts[] = {
    "Inter:style:Medium:size:=12",
    "JetBrainsMono Nerd Font Mono:style:medium:size=20",
    "FontAwesome:style:medium:size=18"
};
...
const char *spcmd1[] = {"kitty", "--class", "spterm1", "--title", "Music", "-e",      "mocp",    NULL};
const char *spcmd2[] = {"kitty", "--class", "spterm2", "--title", "Yazi", "-e",      "yazi",  NULL};
const char *spcmd3[] = {"kitty", "--class",  "spterm3","--title",   "Terminal", NULL};
const char *spcmd4[] = {"kitty", "--class", "spterm4", "--title", "notes", "-e", "nb", "add", NULL};
// const char *spcmd4[] = {"audacious", NULL };
...
/* tagging */
static char *tags[] = {"", "󰖟", "󰭻", "", "", ""};
// static char *tags[] = { "HOME", "WEB", "CHAT", "MEDIA", "DEV", "MISC" };
...
static const int tagschemes[] = {SchemeTag1, SchemeTag2, SchemeTag3, SchemeTag4, SchemeTag5, SchemeTag1};
...
static const Rule rules[] = {
    ...
    {NULL, "spterm3", NULL, SPTAG(2), 1, -1},
    {NULL, "spterm4", NULL, SPTAG(3), 1, -1},
};
...
static const Key keys[] = {
    ...
    {0, XK_Home, spawn, SHCMD("rofi -show drun")},
    {MODKEY, XK_w, spawn, SHCMD("rofi -show window")},
    {MODKEY, XK_x, spawn, SHCMD("rofi -show p")},
    {MODKEY, XK_Return, spawn, SHCMD("kitty")},
    {MODKEY, XK_p, spawn, SHCMD("feh --bg-fill --randomize ~/Pictures/wallpapers")},
    ...
    // } }, { MODKEY|ControlMask,                           XK_k, focusstack,
    // {.i = -1 } }, { MODKEY,                           XK_i,       incnmaster,
    // {.i = +1 } }, { MODKEY,                           XK_d,       incnmaster,
    // {.i = -1 } },
    ...
    {0, XK_Insert, togglescratch, {.ui = 2}},
