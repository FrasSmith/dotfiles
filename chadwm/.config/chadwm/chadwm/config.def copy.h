...
static const char *fonts[]          = {"SpaceMono Nerd Font Mono:style:medium:size:=12","JetBrainsMono Nerd Font Mono:style:medium:size=19" };
...
static const Key keys[] = {
    ...
    { MODKEY,                           XK_Insert,  spawn,             SHCMD("feh --bg-fill --randomize ~/Pictures/wallpapers")},
